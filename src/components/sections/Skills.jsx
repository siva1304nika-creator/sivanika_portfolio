      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-8 flex flex-col justify-between space-y-6">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 p-1 sm:p-1.5 rounded-2xl bg-zinc-950/80 border border-zinc-800/80 overflow-x-auto scrollbar-hide">
              {Object.values(categoriesData).map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-shrink-0 sm:flex-1 min-w-[105px] sm:min-w-[120px] flex items-center justify-center gap-1.5 sm:gap-2.5 py-2.5 sm:py-3 px-2.5 sm:px-4 rounded-xl text-[11px] sm:text-xs md:text-sm font-bold tracking-wider uppercase transition-all duration-300 cursor-pointer ${
                      isActive
                  ...
                  >
                    <Icon className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${isActive ? "text-orange-400" : "text-zinc-400"}`} />
                    <span>{cat.name}</span>
                  </button>
                );
              })}
        ...
        {showAllModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            ...
            >
              ...
              {/* Skills Grid List (Scrollbar hidden, scrolling functional) */}
              <div
                className="flex-1 overflow-y-auto scrollbar-hide pr-2 space-y-4"
